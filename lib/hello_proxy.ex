defmodule HelloProxy do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      # worker(HelloProxy.Worker, [arg1, arg2, arg3]),
    ]
    :hello.start_service(__MODULE__, [])
    :hello.start_listener(@url, [], :hello_proto_jsonrpc, [], :hello_router)
  ...
  def client() do
    :hello_client.start({:local, __MODULE__}, 'zmq-tcp://proxy/server', [], [decoder: @decoder], [])
